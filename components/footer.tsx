    ...
    <footer className="bg-gray-900 text-white">
      <div className="container px-4 mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 py-16">
          <div>
            <h3 className="text-xl font-bold mb-6">Cre8Pixel Company</h3>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-center">
                ...
                <a href="mailto:hello@cre8pixelcompany.com" className="text-gray-400 hover:text-white transition-colors">
                  hello@cre8pixelcompany.com
                </a>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <p className="text-gray-400 mb-4">Subscribe to our newsletter to receive updates and creative insights.</p>
        ...
        <div className="border-t border-gray-800 py-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">
            &copy; {new Date().getFullYear()} Cre8Pixel Company. All rights reserved.
          </p>
      ...
      <button
        onClick={scrollToTop}
        className="fixed bottom-6 right-6 w-12 h-12 rounded-full bg-purple-600 text-white flex items-center justify-center shadow-lg hover:bg-purple-700 transition-colors focus:outline-none"
      >
